  ...
  return (
    <Timeline>
      ...
      <TimelineEvent active>
        ...
        <TimelineEvent.Title><a href='https://maddogcarclub.io/' target='_blank' rel='noopener noreferrer' className='hover:text-white hover:underline transition-all ease cursive text-3xl'>Mad Dog Car Club</a> |  10/2022 - 04/2023</TimelineEvent.Title>

        <TimelineEvent.Description>
          <span className='cursive'>
            <span className='cursive font-semibold  text-2xl text-[#32e0ff]'>Senior Blockchain Front End Developer & Hosting Engineer (Remote, Contract)</span><br />
      ...
      <TimelineEvent>
        ...
        <TimelineEvent.Title><a href='https://www.autoscribe.com/' target='_blank' rel='noopener noreferrer' className='hover:text-white hover:underline transition-all ease cursive text-3xl'>AutoScribe</a> | 03/2022 - 10/2022</TimelineEvent.Title>

        <TimelineEvent.Description>
          <span className='cursive'>
            <span className='cursive font-semibold  text-2xl text-[#32e0ff]'>React Full Stack Developer (Remote, Contract)</span><br />
      ...
      <TimelineEvent>
        ...
        <TimelineEvent.Title><a href='https://www.bitfinex.com/' target='_blank' rel='noopener noreferrer' className='hover:text-white hover:underline transition-all ease cursive text-3xl'>Bitfinex</a> | 03/2020 - 03/2022</TimelineEvent.Title>

        <TimelineEvent.Description>
          <span className='cursive'>
            <span className='cursive font-semibold  text-2xl text-[#32e0ff]'>Full Stack Blockchain Engineer (Remote, Full-time)</span><br />
      ...
      <TimelineEvent>
        ...
        <TimelineEvent.Title><a href='https://www.dejero.com/' target='_blank' rel='noopener noreferrer' className='hover:text-white hover:underline transition-all ease cursive text-3xl'>Dejero Labs</a> | 12/2017 - 02/2020</TimelineEvent.Title>

        <TimelineEvent.Description>
        <span className='cursive'>
          <span className='cursive font-semibold  text-2xl text-[#32e0ff]'>Full Stack Developer (Hybrid Remote, Full-Time)</span><br />
      ...
      <TimelineEvent last>
        ...
        <TimelineEvent.Title><a href='https://www.reddoorz.com/' target='_blank' rel='noopener noreferrer' className='hover:text-white hover:underline transition-all ease cursive text-3xl'>RedDoorz</a> | 09/2016 - 10/2017</TimelineEvent.Title>

        <TimelineEvent.Description>
        <span className='cursive'>
          <span className='cursive font-semibold  text-2xl text-[#32e0ff]'>React Front End Developer & UI Designer (Onsite, Full-Time)</span><br />
