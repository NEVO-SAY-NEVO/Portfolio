...
export default function Navbar() {
  ...
  return (
    <header className="w-full font-header mx-auto  px-4 sm:px-[100px] fixed top-0 z-50 text-[#32e0ff] cursor-pointer hover:text-white shadow-lg shadow-[#000000d2] bg-[#0c1430]">
